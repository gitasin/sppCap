...
entity Vendor_Pool_Mst {	
    ...
    regular_evaluation_yn : Boolean @title: '정기평가여부';
    industry_class_code : String(30) @title: '산업분류코드';
    sd_exception_yn : Boolean @title: '공급업체발굴예외여부';
    vendor_pool_exception_yn : Boolean @title: '협력사풀예외여부';
    ...
    vendor_pool_use_yn : Boolean @title: '협력사풀사용여부';
