...
entity Vendor_Pool_Manager_Dtl {	
  ...
  key operation_org_type_code : String(2)   @title: '운영조직유형코드';	
  key operation_org_code : String(10)   @title: '운영조직코드';	
  ...
  key manager_empno : String(30)   @title: '담당자사번';	
    role_text : String(500)   @title: '역할텍스트';	
    use_flag : Boolean   @title: '사용여부';	
    register_reason_text : String(3000)   @title: '등록사유텍스트';	
